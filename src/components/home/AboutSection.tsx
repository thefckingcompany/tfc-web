        ...
        <section className="pt-0 pb-12 bg-white text-black overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-10 sm:px-8 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-20">
                    ...
                    {/* Image Column */}
                    <div className="relative group animate-fade-in-left h-full lg:col-span-1">
                    ...
                    {/* Content Column */}
                    <div className="animate-fade-in-right space-y-6 flex flex-col justify-center lg:col-span-2">
