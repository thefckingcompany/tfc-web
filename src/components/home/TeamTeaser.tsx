            ...
            <div className="max-w-7xl mx-auto px-10 sm:px-8 lg:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {barbers.map((barber, index) => (
                        <ScrollReveal key={barber.name} width="100%" delay={index * 0.1}>
                            <div
                                className="group relative h-64 sm:h-[500px] overflow-hidden block card-premium"
                            >
                                <img
                                    src={barber.img}
                                    alt={barber.name}
                ...
                <ScrollReveal width="100%" delay={0.2}>
                    <div className="text-center mt-10">
                        <Link
                            to="/reservar"
                            className="inline-block px-12 py-5 bg-black text-white font-oswald font-bold text-2xl uppercase tracking-widest hover:bg-gray-900 transition-colors transform skew-x-[-10deg] btn-premium"
                        >
