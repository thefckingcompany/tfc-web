                ...
                <ScrollReveal width="100%" delay={0.4}>
                    <div className="flex flex-col sm:flex-row justify-center gap-6 mt-10">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center justify-center gap-3 px-10 py-4 bg-black text-white font-oswald font-bold text-sm uppercase tracking-[0.2em] hover:bg-[#25D366] transition-colors min-w-[200px] btn-premium"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center justify-center gap-3 px-10 py-4 border border-black text-black font-oswald font-bold text-sm uppercase tracking-[0.2em] hover:text-white hover:border-transparent hover:bg-gradient-to-r hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#F77737] transition-all min-w-[200px] btn-premium"
                        >
                            <Instagram size={18} />
                            Instagram
                        </a>
