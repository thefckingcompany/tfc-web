                ...
                <AnimatePresence>
                    {isOpen && (
                        ...
                        >
                            ...
                            {/* Navigation Links - RESTORED STYLE but with responsive flex spacing */}
                            <motion.div
                                className="flex-grow flex flex-col items-center justify-evenly py-4 overflow-hidden"
                                initial="closed"
                                animate="open"
                                exit="closed"
                                variants={{
                            ...
                            >
                                    ...
                                    {navLinks.map((link) => (
                                        ...
                                        >
                                            <Link
                                                to={link.path}
                                                onClick={() => setIsOpen(false)}
                                                className="text-3xl sm:text-4xl font-oswald font-bold tracking-widest text-white hover:text-gray-400 uppercase transition-colors block p-1"
                                            >
                                                {link.name}
                                            </Link>
                                        </motion.div>
                                ...
                                >
                                    <Link
                                        to="/reservar"
                                        onClick={() => setIsOpen(false)}
                                        className="px-10 py-3 sm:px-12 sm:py-4 bg-white text-black font-oswald font-bold tracking-widest uppercase hover:bg-gray-200 transition-colors inline-block text-sm sm:text-base"
                                    >
                                        Reservar Cita
                                    </Link>
                                </motion.div>
