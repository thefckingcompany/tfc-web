        ...
        <div className="bg-white text-black pt-12 pb-12 px-10 sm:px-8 lg:px-8">
                ...
                <div>
                    <div className="flex flex-col gap-0">
                        {categories[0].items.map((item, index) => (
                            <ScrollReveal key={item.name} width="100%" delay={index * 0.05}>
                                <div className="flex flex-col group py-6 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors px-4 rounded-lg card-premium">
            ...
            <ScrollReveal width="100%" delay={0.2}>
                <div className="text-center mt-2">
                    ...
                    <Link
                        to="/reservar"
                        className="inline-block px-12 py-4 bg-black text-white font-oswald font-bold text-sm uppercase tracking-[0.2em] hover:bg-gray-800 transition-colors btn-premium"
                    >
                        Reservar Cita
                    </Link>
                </div>
